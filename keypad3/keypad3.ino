...
byte rowPins[ROWS] = {14, 15, 16, 17}; // Estos son los pines de conexión de Arduino de las columnas
byte colPins[COLS] = { 18,19,20,21}; //Estos son los pines de conexión de Arduino de las filas
...
void loop()
{
 ...
 if(codigo!=contrasena) //empieza un nuevo ciclo, esta vez indicamos si el código es diferente que la contraseña siga con el ciclo
